...
const kinect = require('./binding/napi-v4/kinect2.node');

class Kinect2 extends EventEmitter {
  constructor() {
    super({});
    this.colorFrameCallback = this.colorFrameCallback.bind(this);
    this.recordColorFrameCallback = this.colorFrameCallback.bind(this);
  ...
  recordVideoRGB() {
    return kinect.recordVideoRGB(this.recordColorFrameCallback);
  };
  recordColorFrameCallback(data) {
    this.emit('recordColorFrame', data);
  }
